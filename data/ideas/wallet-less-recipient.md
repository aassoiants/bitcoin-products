## wallet-less-recipient

| Field | Value |
|---|---|
| slug | wallet-less-recipient |
| statement | Pay someone who doesn't have a wallet yet. |
...
- BitcoinsWithFriends (2013, san-jose-bitcoin-2013) — Facebook social-graph onboarding via lending small amounts of bitcoin to friends
- Aircoin (2014, coinbase-bithack-2014) — mobile proximity transfer to a nearby person; 2nd Place, $5,000
- El Dorado (2016, bay-bithack-2016) — merchant-pushed QR bitcoin loyalty rewards; customer doesn't need to know their wallet address
- Lightsats (2022, lol-1-2022) — pre-coiner self-onramp via LNURL-withdraw tips and gifts
