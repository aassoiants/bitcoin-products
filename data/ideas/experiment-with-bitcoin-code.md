...
### Past products (6, 1 alive)

- Polar (2019, alive) — one-click Lightning regtest network
- BitScript (2017, wound-down) — bitcoin script execution and debugging environment
- Simplicity Playground (2025, dormant) — Simplicity language playground
- TANOS (2025, dormant) — L2 test environment
- MareNostrum (2025, dormant) — test environment for L2 work
- Warnet (Brink-funded, alive) — Bitcoin Core network simulation at scale via Kubernetes
