...
### Past products (3, status mix)

- Bowser (2020, fulmo-2020-jun, wound-down) — M5Stack ESP32 DIY signing device by arcbtc; codebase absorbed into LNbits hardware-wallet repo (archived 2022)
- Bitaxe authentication (2025, bitcoinpp-pool-2025) — addon that prevents unauthorized pool pointing on shared home networks
- MuSig2 Support for Satochip (2025, bitcoin-2025-official) — open-source hardware wallet multisig extension
