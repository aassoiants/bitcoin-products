...
| audiences | bitcoin-user,node-operator |
| first_added | 2026-04-27 |
| last_reviewed | 2026-04-27 |

### Past products (6, 3 alive)

- Forkscanner (2023, mit-bitcoin-2023, alive, deep-scraped) — Real-time Bitcoin network monitoring and fork/stale-block notifications
- OP_RETURN.space (2025, bitcoinpp-pool-2025, alive, deep-scraped) — Explorer simulating an unlimited OP_RETURN chain
- memepool.cool (2025, bitcoinpp-pool-2025, deep-scraped, status as captured) — Live browser-based Bitcoin mempool explorer
- Sats Guardian (2025, bitcoinpp-beach-2025, alive, deep-scraped) — On-chain watchtower detecting theft in real-time with recovery transactions
- Ordverse (2023, bitcoin-olympics-2023, deep-scraped, status as captured) — Datahub & Search Engine for Recursive Ordinals
- Double-spend monitor (2012, berlin-bitcoin-2012, dead, deep-scraped) — Real-time mempool conflict detection
