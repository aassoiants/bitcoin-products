...
| category | reach |
| archetype | build |
| audiences | bitcoin-user,newcomer,creator-merchant |
| first_added | 2026-04-27 |
| last_reviewed | 2026-04-27 |

### Past products (3, 1 alive)

- LightningATM (2020-2021, fulmo-2020-may + fulmo-2020-jun + fulmo-2021-mar, alive, deep-scraped) — DIY Lightning-cash kiosk by 21isenough; explicit hobbyist scope per creator; last release v0.3.1 May 2023
- Lightning ATMs (2019, lightning-hack-day-hk-2019, status as captured) — Integrate Eclair with General Bytes ATMs for Lightning top-up (Felix)
- Lightning Network enabled Vending Machine (2019, bitcoin-games-2019, status as captured) — Vue.js vending machine accepting Bitcoin Lightning payments via OpenNode API (Lambert family)
